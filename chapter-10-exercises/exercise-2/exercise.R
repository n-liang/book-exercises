...
salaries[salaries$adjustements == max(salaries$adjustments), "employees"]

# What was the largest decrease in salaries between the two years?
salaries[salaries$adjustments == min(salaries$adjustments), "adjustments"]

# What was the name of the employee who recieved largest decrease in salary?
salaries[salaries$adjustements == min(salaries$adjustments), "employees"]
...
write.csv(salaries, "salary_data", row.names = TRUE)
